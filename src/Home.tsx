...
function Home() {
 ...
 &&  <a className="white"  href="https://dl.dropbox.com/scl/fi/90pbzilpwnamii3iy85ej/Omni-files.apk?rlkey=baywstnl3iqj7nh7471l33ns6&dl=0" ><h4>Get the android app HERE!</h4></a>
         }
        </div>
      </div>
    </>
